	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function _gather_plugin_data() {
			...
			foreach ( $plugins[ $this->view_context ] as $slug => $plugin ) {
				...
				$table_data[ $i ]['afflink']           = $this->get_plugin_afflink( $plugin );
		...
		/**
		 * WeddingSaas - Get affiliate link.
		 */
		protected function get_plugin_afflink( $item ) {
			$link = '-';
			if ( isset($item['afflink']) && $item['afflink'] ) {
				$link = '<a href="' . $item['afflink'] . '" target="_blank">'. __( 'Unduh', 'weddingsaas' ) . '</a>';
			}
		...
		public function get_columns() {
			...
			$columns['afflink'] = __( 'Rekomendasi', 'weddingsaas' );
