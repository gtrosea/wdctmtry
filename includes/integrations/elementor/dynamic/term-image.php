...
/**
 * Dynamic_Term_Image Class.
 */
class Dynamic_Term_Image extends \Elementor\Core\DynamicTags\Data_Tag {

	/**
	 * Retrieves the name of the dynamic tag.
	 */
	public function get_name() {
		return 'wds-term-image';
	}
	...
	public function get_title() {
		return __( 'Term Image', 'wds-notrans' );
	}
	...
	public function get_value( array $options = array() ) {
		...
		if ( $theme_id ) {
			$value = get_term_meta( $theme_id, $field, true );
		}
