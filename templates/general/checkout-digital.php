...
$sk_content   = wds_option( 'sk_content_digital' );
...
<form action="" method="POST" id="checkout_form" class="form w-100 mb-n8 mb-lg-n10" novalidate="novalidate" data-id="<?php echo esc_attr( $checkout_id ); ?>" data-type="digital">
	...
	<div class="product">
		...
		<div class="d-flex flex-stack">
			...
			<div class="text-gray-900 fw-bolder fs-6"><?php echo esc_html( wds_data( 'product_price' ) ); ?><span class="text-gray-400 fw-bold fs-6"><?php echo esc_html( wds_data( 'product_price_period' ) ); ?></div>
